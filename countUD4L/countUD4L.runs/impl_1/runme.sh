...
HD_PWD='C:/Users/Anti-cheat-WIN10/Documents/countUD4L/countUD4L.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log countUD4L.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source countUD4L.tcl -notrace
