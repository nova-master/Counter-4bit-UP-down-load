...
HD_PWD='C:/Users/Anti-cheat-WIN10/Documents/countUD4L/countUD4L.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log countUD4L.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source countUD4L.tcl
